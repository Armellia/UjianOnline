          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <form action="insertdatakelas.php" method="post" class="from-horizontal" role="form">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <input type="text" class="form-control" id="lastname" placeholder="Kelas" name="kelas">
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table tablesorter " id="">
                          ...
                          <?php
                                            $query="select *,tbjurusan.nama as namaj, tbkelas.nama as namak from tbkelas inner join 
                                            tbjurusan on tbkelas.kodejurusan=tbjurusan.kodejurusan";
                                            $execute=mysqli_query($koneksi,$query);
                                            $i=1;
                                            while($data=mysqli_fetch_array($execute)){
                                          ?>
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <a href="kelasedit.php?kodekelas=<?php echo $data['kodekelas']?>">Ubah</a>
                                | <a href="proseshapuskelas.php?kodekelas=<?php echo $data['kodekelas']?>"
