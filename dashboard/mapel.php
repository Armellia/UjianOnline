          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <form action="insertdatamapel.php" method="post" class="from-horizontal" role="form">
                      <div class="form-group">
                        <div class="col-sm-12">
                          <label for="">Mata Pelajaran</label>
                          <input type="text" class="form-control" id="lastname" placeholder="Mata Pelajaran"
                            name="mapel">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table tablesorter " id="">
                          ...
                          <?php
                                            $query="select tbmapel.kodemapel as kodemapel,tbmapel.nama as mapel,tbkelas.kelas as kelas,tbjurusan.nama as jurusan from tbmapel inner join tbjurusan on tbmapel.kodejurusan=tbjurusan.kodejurusan 
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <a href="mapeledit.php?kodemapel=<?php echo $data['kodemapel']?>">Ubah</a>
                                | <a href="proseshapusmapel.php?kodemapel=<?php echo $data['kodemapel']?>"
