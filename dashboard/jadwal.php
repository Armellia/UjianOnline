            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Data Jadwal</a>
                    </div>
                                        ...
                                        <form action="insertdatajadwal.php" method="post" class="from-horizontal" role="form">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                  <label>Tanggal Ujian</label>
                                                    <input type="date" class="form-control" id="" name="hari">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="" placeholder="Ruangan" name="ruangan">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Jam Mulai</label>
                                                    <input type="time" class="form-control" id="" name="jammulai">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                <label>Jam Selesai</label>
                                                    <input type="time" class="form-control" id="" name="jamselesai" value="">
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table tablesorter " id="">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <a href="jadwaledit.php?kodejadwal=<?php echo $data['kodejadwal']?>">Ubah</a> 
                                                | <a href="proseshapusjadwal.php?kodejadwal=<?php echo $data['kodejadwal']?>"
